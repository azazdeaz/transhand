...
/***/ function(module, exports, __webpack_require__) {
	...
	function scatterThings() {
	  var colors = ['#7FDBFF', '#0074D9', '#001F3F', '#39CCCC', '#3D9970', '#FF4136', '#85144B', '#FF851B', '#B10DC9', '#FFDC00', '#F012BE', '#aaa', '#fff', '#ddd'];
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      if (currDomElem) {
	        ...
	        return _react2['default'].createElement(_SRCCSSTranshand2['default'], props);
	      } else {
