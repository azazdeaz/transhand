...
/***/ function(module, exports, __webpack_require__) {
	...
	var _prepare = __webpack_require__(128);
	...
	_react2['default'].render(_react2['default'].createElement(_App2['default'], null), document.querySelector('#mount-app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SRCCssTranshand = __webpack_require__(6);

	var _SRCCssTranshand2 = _interopRequireDefault(_SRCCssTranshand);

	var _lodashObjectAssign = __webpack_require__(21);
	...
	var App = (function (_React$Component) {
	  function App() {
	    ...
	    this.handleChange = function (change) {
	      ...
	      var params = currDomElem._handlerParams;

	      (0, _lodashObjectAssign2['default'])(params, change);

	      currDomElem.style.transform = _this.generateCssTransform(params);
	  ...
	  _createClass(App, [{
	    ...
	    value: function elementFromPoint(x, y) {
	      ...
	      if (deHandler) {
	        var save = deHandler.style.display;
	    ...
	    value: function generateCssTransform(params) {
	    ...
	    value: function render() {
	      var currDomElem = this.state.currDomElem;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./obj_cookiejar001.png": 8,
		"./obj_fan001.png": 9,
		"./obj_kettle001.png": 10,
		"./obj_mixer001.png": 11,
		"./obj_radio001.png": 12,
		"./obj_speaker001.png": 13,
		"./obj_speaker002.png": 14,
		"./obj_toaster001.png": 15,
		"./obj_tv001.png": 16,
		"./obj_tv002.png": 17
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Transhand = __webpack_require__(23);

	var _Transhand2 = _interopRequireDefault(_Transhand);

	var _CssCoordinator = __webpack_require__(24);

	var _CssCoordinator2 = _interopRequireDefault(_CssCoordinator);

	var _lodashLangIsElement = __webpack_require__(22);
	  ...
	  _createClass(CssTranshand, [{
	    ...
	    value: function takeNextDeTarget(nextDeTarget) {
	      ...
	      if (this._lastTakenDeTarget !== nextDeTarget) {
	        ...
	        this.coordinator.setLocalRoot(nextDeTarget.parentElement, nextDeTarget, function (base) {
	          _this2.setState({ base: base, foo: 3 });
	        });
	      }
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(_Transhand2['default'], {
	        base: base,
	        params: params,
	    ...
	    value: {
	      ...
	      props: _react2['default'].PropTypes.shape({
	        tx: _react2['default'].PropTypes.number,
	        ty: _react2['default'].PropTypes.number,
	        sx: _react2['default'].PropTypes.number,
	        sy: _react2['default'].PropTypes.number,
	        rz: _react2['default'].PropTypes.number,
	        ox: _react2['default'].PropTypes.number,
	        oy: _react2['default'].PropTypes.number }) },
	    enumerable: true
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "assets/obj_cookiejar001.png"

/***/ },
/* 9 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "assets/obj_fan001.png"

/***/ },
/* 10 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "assets/obj_kettle001.png"

/***/ },
/* 11 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "assets/obj_mixer001.png"

/***/ },
/* 12 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "assets/obj_radio001.png"

/***/ },
/* 13 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "assets/obj_speaker001.png"

/***/ },
/* 14 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "assets/obj_speaker002.png"

/***/ },
/* 15 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "assets/obj_toaster001.png"

/***/ },
/* 16 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "assets/obj_tv001.png"

/***/ },
/* 17 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "assets/obj_tv002.png"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashLangClone = __webpack_require__(19);
	...
	var _shallowEquals = __webpack_require__(132);
	...
	var _DefaultCoordinator = __webpack_require__(64);
	...
	var Transhand = (function (_React$Component) {
	  function Transhand(prosp) {
	    var _this = this;

	    _classCallCheck(this, Transhand);

	    _get(Object.getPrototypeOf(Transhand.prototype), 'constructor', this).call(this, prosp);

	    this.handleMouseDown = function (e) {

	      if (!_this.state.finger) {
	        return;
	      }
	      ...
	      _react2['default'].findDOMNode(_this.refs.root).style.pointerEvents = 'auto';

	      _this._mdPos = {
	        m: _this.props.coordinator.globalToLocal({ x: e.clientX, y: e.clientY }),
	        params: (0, _lodashLangCloneDeep2['default'])(_this.props.params),
	    ...
	    this.handleMouseMove = function (e) {
	      ...
	      if (!_this._isHandle && _this.state.hoverHitbox) {
	        _this.setFinger(e);
	      } else {}
	    };
	    ...
	    this.handleMouseUp = function (e) {
	      ...
	      _react2['default'].findDOMNode(_this.refs.root).style.pointerEvents = 'none';
	    ...
	    this.deferredHandleDrag = function () {
	      ...
	      var onChange = _props.onChange;var _state = _this.state;
	      var pOrigin = _state.pOrigin;

	      var finger = _state.finger;
	      var md = _this._mdPos;
	      ...
	      function setScale(r, sN, way) {
	        ...
	        var rad = r + md.params.rz,
	            mdDist = (0, _utils.distToPointInAngle)(md.pOrigin, md.m, rad),
	            dragDist = (0, _utils.distToPointInAngle)(md.pOrigin, m, rad),
	      ...
	      function fixProportion() {
	        ...
	        var mx = m.x - pOrigin.x,
	            my = m.y - pOrigin.y,
	            mr = Math.abs((0, _utils.radDiff)(params.rz, Math.atan2(my, mx))),
	  ...
	  _createClass(Transhand, [{
	    ...
	    value: function refreshPoints(props) {
	      ...
	      var p = this.state.points.map(function (p) {
	        return (0, _lodashLangClone2['default'])(p);
	      });
	      var po = (0, _lodashLangClone2['default'])(this.state.pOrigin);

	      base = (0, _lodashLangClone2['default'])(base);
	    ...
	    key: 'setFinger',
	    value: function setFinger(e) {
	      var _props2 = this.props;
	      var base = _props2.base;
	      var params = _props2.params;
	      var coordinator = _props2.coordinator;
	      var originRadius = _props2.originRadius;
	      ...
	      var dox = po.x - m.x;
	      var doy = po.y - m.y;
	      var dOrigin = Math.sqrt(dox * dox + doy * doy);
	      ...
	      this.setState({ finger: finger, cursorScale: cursorScale, cursor: cursor });
	    }
	  }, {
	    key: 'getCursor',
	    value: function getCursor(e, finger, cursorScale) {
	    ...
	    value: function getRotateCursor(mx, my) {
	    ...
	    key: 'getScaleCursor',
	    value: function getScaleCursor() {

	      var FINGERS = ['0100', '0110', '0010', '0011', '0001', '1001', '1000', '1100'];

	      var _props3 = this.props;
	      var coordinator = _props3.coordinator;
	      var params = _props3.params;var _state3 = this.state;
	      var pOrigin = _state3.pOrigin;

	      var finger = _state3.finger;
	      ...
	      var baseRad = Math.atan2(pot.y - po.y, pot.x - po.x) + params.rz;
	    ...
	    key: 'getHitEvents',
	    value: function getHitEvents() {
	      var _this3 = this;

	      //TODO onFirstMove - handle when transhand appears under the mouse
	      return {
	        onMouseEnter: function onMouseEnter() {
	          return _this3.setState({ hoverHitbox: true });
	        },
	        onMouseLeave: function onMouseLeave() {
	          return _this3.setState({ hoverHitbox: false });
	        },
	    ...
	    value: function render() {
	      ...
	      var rotateFingerDist = _props4.rotateFingerDist;
	      var originRadius = _props4.originRadius;
	      var stroke = _props4.stroke;
	      var coordinator = _props4.coordinator;
	      var cursor = this.state.cursor;
	      var p = this.state.points.map(function (p) {
	        return coordinator.localToGlobal(p);
	      });
	      var po = coordinator.localToGlobal(this.state.pOrigin);
	      var or = this.props.originRadius;
	      ...
	      return _react2['default'].createElement(
	        'svg',
	        { ref: 'root', style: styles.root },
	        _react2['default'].createElement('polygon', _extends({ ref: 'canvas',
	          fill: 'none'
	        }, stroke, {
	          points: boxHitPoints })),
	        _react2['default'].createElement('line', _extends({ x1: po.x - or, y1: po.y, x2: po.x + or, y2: po.y }, stroke)),
	        _react2['default'].createElement('line', _extends({ x1: po.x, y1: po.y - or, x2: po.x, y2: po.y + or }, stroke)),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _heuristicGlobalToLocal = __webpack_require__(66);

	var _heuristicGlobalToLocal2 = _interopRequireDefault(_heuristicGlobalToLocal);

	var _lodashCollectionFindWhere = __webpack_require__(67);
	    ...
	    value: function setLocalRoot(deParent, deTarget, onDone) {
	      ...
	      var done = function done() {
	        ...
	        if (_this.onProcessingDone) {
	          _this.onProcessingDone(_this._base);
	      ...
	      var setBase = function setBase() {
	        ...
	        if (_this._hasTransform) {
	          var brB = deParent.getBoundingClientRect();
	      ...
	      if (this._hasTransform) {
	        ...
	        var brParent = deParent.getBoundingClientRect();
	        var brLastTransformed = transformeds[transformeds.length - 1];
	...
	var MockDiv = (function (_React$Component) {
	  ...
	  _createClass(MockDiv, [{
	    ...
	    value: function render() {
	      ...
	      var transformReg = transformList[transformListIdx];var br = transformReg.br;
	      ...
	      return _react2['default'].createElement(
	        ...
	        { style: (0, _lodashObjectAssign2['default'])({
	            ...
	            width: br.width,
	            height: br.height }, transformReg.style) },
	        renderChild()
	      );
	    }
	  }], [{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isIndex = __webpack_require__(134);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getSymbols = __webpack_require__(145),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseCopy = __webpack_require__(147),
	    getSymbols = __webpack_require__(145),
	    isNative = __webpack_require__(148),
	    keys = __webpack_require__(146);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isNative = __webpack_require__(148),
	    shimIsPlainObject = __webpack_require__(149);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashObjectDefaults = __webpack_require__(150);

	var _lodashObjectDefaults2 = _interopRequireDefault(_lodashObjectDefaults);

	var Styles = function Styles(config) {
	  _classCallCheck(this, Styles);

	  (0, _lodashObjectDefaults2['default'])(config, {
	    rotateFingerDist: 16,
	    originRadius: 6 });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function scatterThings() {
	  ...
	  var srcs = ['cookiejar001', 'fan001', 'kettle001', 'mixer001', 'radio001', 'speaker001', 'speaker002', 'toaster001', 'tv001', 'tv002'].map(function (name) {
	  ...
	  for (var i = 0; i < 3; ++i) {
	    var deParent = rootNode;

	    var w = 242 + 132 * Math.random();
	    var h = 242 + 132 * Math.random();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bufferClone = __webpack_require__(199);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var escapeRegExp = __webpack_require__(203),
	    isObjectLike = __webpack_require__(58);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(21),
	    assignDefaults = __webpack_require__(205),
	    restParam = __webpack_require__(54);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIsMatch = __webpack_require__(206),
	    constant = __webpack_require__(200),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseEach = __webpack_require__(208),
	    createFind = __webpack_require__(209);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var constant = __webpack_require__(200),
	    isNative = __webpack_require__(148);
