...
/***/ function(module, exports, __webpack_require__) {
	...
	var CustomTranshandDesign = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CustomTranshandDesign = (function (_React$Component) {
	  function CustomTranshandDesign() {
	    _classCallCheck(this, CustomTranshandDesign);
	  ...
	  _inherits(CustomTranshandDesign, _React$Component);

	  _createClass(CustomTranshandDesign, [{
	    key: 'render',
	    value: function render() {
	      ...
	      var boxPath = 'M' + p[0].x + ' ' + p[0].y + ' ' + ('L' + p[1].x + ' ' + p[1].y + ' ') + ('L' + p[2].x + ' ' + p[2].y + ' ') + ('L' + p[3].x + ' ' + p[3].y + ' ') + ('L' + p[0].x + ' ' + p[0].y + ' ') + ('L' + p[1].x + ' ' + p[1].y + ' ') + ('L' + p[2].x + ' ' + p[2].y + ' ') + ('L' + p[3].x + ' ' + p[3].y + ' ') + ('L' + p[0].x + ' ' + p[0].y + ' ') + ('L' + p[2].x + ' ' + p[2].y + ' ') + ('M' + p[3].x + ' ' + p[3].y + ' ') + ('L' + p[1].x + ' ' + p[1].y);
	  ...
	  return CustomTranshandDesign;
	})(_react2['default'].Component);

	exports['default'] = CustomTranshandDesign;
	module.exports = exports['default'];
